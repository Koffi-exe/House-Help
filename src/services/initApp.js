...
const initApp = async () => {
    try {
        ...
        if (loggedUser && loggedUser.userId ) {
            const employeeResponse = await axios.get('http://54.175.255.7:5000/api/list/employees')
            ...
            const employerResponse = await axios.get('http://54.175.255.7:5000/api/list/employers')
